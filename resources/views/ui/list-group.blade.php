@extends('layouts.vertical', ['title' => 'List Group', 'topbarTitle' => 'List Group'])
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><i class="ti ti-brand-intercom me-1 align-middle fs-18"></i>
                            Intercom
                            Support System</li>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item active"><i
                                class="ti ti-brand-google-drive me-1 align-middle fs-18"></i> Google Drive
                        </li>
                        <li class="list-group-item"><i class="ti ti-brand-messenger me-1 align-middle fs-18"></i>
                            Facebook Messenger</li>
                        <li class="list-group-item"><i class="ti ti-brand-apple me-1 align-middle fs-18"></i> Apple
                    ...
                    <ol class="list-group list-group-numbered">
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Adminto Admin</div>
                                Adminto Admin
                            </div>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Adminto React Admin</div>
                                Adminto React Admin
                            </div>
