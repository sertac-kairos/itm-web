@extends('layouts.vertical', ['title' => 'Create Invoice', 'topbarTitle' => 'Create Invoice'])
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start justify-content-between mb-4">
                        <div class="overflow-hidden position-relative border rounded d-flex align-items-center justify-content-start px-2"
                            ...
                            <img id="preview" src="/images/logo-dark.png" alt="Preview Image"
                                height="28">
                        </div>
        ...
        <div class="mb-5">
            <div class="d-flex justify-content-center gap-2">
                ...
                <a href="javascript: void(0);" class="btn btn-info gap-1"><i
                        class="ti ti-send fs-16"></i> Send Invoice</a>
            </div>
        </div>
        <!-- end buttons -->
    </div>
