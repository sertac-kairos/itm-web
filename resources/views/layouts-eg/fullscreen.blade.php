@extends('layouts.vertical', ['title' => 'Fullscreen Layout', 'topbarTitle' => 'Fullscreen'])

@section('html_attribute')
lang="en" data-sidenav-size="fullscreen"
@endsection
                ...
                <div class="border-top border-dashed mt-2">
                    <div class="row text-center align-items-center g-0">
                        <div class="col-md-4 col-12">
                            ...
                            <img src="/images/cards/american-express.svg" alt="user-card" height="36" />
                            <img src="/images/cards/discover-card.svg" alt="user-card" height="36" />
                            <img src="/images/cards/mastercard.svg" alt="user-card" height="36" />
                        </div>
                        <div class="col-md-4 col-6 border-start border-end border-dashed">
                            <p class="text-muted mt-3 mb-1">Expenses</p>
                            <h4 class="mb-3">
    ...
    <div class="col">
        <div class="card">
            <div class="card-body d-flex align-items-center gap-2">
                <img src="/images/users/avatar-7.jpg" alt="team-member-image" class="me-1 avatar-xl img-thumbnail rounded-circle">
                <div>
                    <h5>John Smith</h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-primary-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-1.svg" alt="" height="22">
                                            </span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-info-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-2.svg" alt="" height="22">
                                            </span>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-primary-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-3.svg" alt="" height="22">
                                            </span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-secondary-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-4.svg" alt="" height="22">
                                            </span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-md flex-shrink-0 me-2">
                                            <span class="avatar-title bg-danger-subtle rounded-circle">
                                                <img src="/images/products/logo/logo-5.svg" alt="" height="22">
                                            </span>
                                        </div>
                                        <div>
                    ...
                    <table class="table table-custom align-middle table-nowrap table-hover mb-0">
                        <tbody>
                            <tr>
                                <td style="width: 85px;">
                                    <div class="avatar-lg border rounded">
                                        <img src="/images/products/p-1.png" alt="Product-10" class="img-fluid rounded-2">
                                    </div>
                                </td>
                                <td class="ps-0">
                            ...
                            <tr>
                                <td style="width: 85px;">
                                    <div class="avatar-lg border rounded">
                                        <img src="/images/products/p-2.png" alt="Product-11" class="img-fluid rounded-2">
                                    </div>
                                </td>
                                <td class="ps-0">
                            ...
                            <tr>
                                <td style="width: 85px;">
                                    <div class="avatar-lg border rounded">
                                        <img src="/images/products/p-3.png" alt="Product-12" class="img-fluid rounded-2">
                                    </div>
                                </td>
                                <td class="ps-0">
                            ...
                            <tr>
                                <td style="width: 85px;">
                                    <div class="avatar-lg border rounded">
                                        <img src="/images/products/p-4.png" alt="Product-13" class="img-fluid rounded-2">
                                    </div>
                                </td>
                                <td class="ps-0">
                            ...
                            <tr>
                                <td style="width: 85px;">
                                    <div class="avatar-lg border rounded">
                                        <img src="/images/products/p-5.png" alt="Product-14" class="img-fluid rounded-2">
                                    </div>
                                </td>
                                <td class="ps-0">
