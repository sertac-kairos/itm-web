@extends('layouts.vertical', ['title' => 'Ören Yeri Düzenle - İzmir Time Machine', 'topbarTitle' => 'Ören Yeri Düzenle'])
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">Ören Yeri Düzenle</h4>
        </div>
    </div>
</div>

<!-- Form -->
<form action="{{ route('admin.archaeological-sites.update', $archaeologicalSite) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    @if(isset($returnUrl))
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title">Ören Yeri Bilgileri</h4>
                    <p class="text-muted mb-0">Ören yerinin temel özelliklerini belirleyin</p>
                </div>
                <div class="card-body">
                    <!-- Dil Sekmeleri -->
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="#{{ $locale }}-tab" data-bs-toggle="tab" aria-expanded="{{ $index === 0 ? 'true' : 'false' }}" 
                                   class="nav-link {{ $index === 0 ? 'active' : '' }}" role="tab">
                                    ...
                                    @if($archaeologicalSite->hasTranslation($locale))
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="{{ $locale }}_name" class="form-label">
                                                Ören Yeri Adı @if($locale === 'tr') <span class="text-danger">*</span> @endif
                                            ...
                                            <input type="text" class="form-control @error($locale.'.name') is-invalid @enderror" 
                                                   ...
                                                   value="{{ old($locale.'.name', $archaeologicalSite->translate($locale, false)?->name) }}">
                                            @error($locale.'.name')
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error($locale.'.description') is-invalid @enderror" 
                                                      ...
                                                      rows="4" placeholder="Ören yeri hakkında açıklama yazın...">{{ old($locale.'.description', $archaeologicalSite->translate($locale, false)?->description) }}</textarea>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            @php
                                                $translation = $archaeologicalSite->translate($locale, false);
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title">Konum Bilgileri <span class="text-danger">*</span></h4>
                    <p class="text-muted mb-0">Ören yerinin harita koordinatlarını belirleyin</p>
                </div>
                <div class="card-body">
                    <!-- Koordinatlar -->
                    <div class="mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('latitude') is-invalid @enderror" 
                                           id="latitude" name="latitude" value="{{ old('latitude', $archaeologicalSite->latitude) }}" 
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('longitude') is-invalid @enderror" 
                                           id="longitude" name="longitude" value="{{ old('longitude', $archaeologicalSite->longitude) }}" 
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Konum Belirleme Yardımı:</strong>
                        <p class="mb-0 mt-1">
                            Google Maps'ten koordinat almak için: Haritada istediğiniz noktaya sağ tıklayın ve çıkan menüden koordinatları kopyalayın.
                            Ören yerleri için koordinat zorunludur.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- Yan Panel -->
        <div class="col-lg-4">
            <!-- Bölge ve Alt Bölge Seçimi -->
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title">Bölge Seçimi</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label for="region_id" class="form-label">
                            Ana Bölge <span class="text-danger">*</span>
                        </label>
                        <select class="form-select" id="region_id" name="region_id" required>
                            <option value="">Bölge Seçin</option>
                            @foreach($regions as $region)
                                <option value="{{ $region->id }}" 
                                        {{ old('region_id', $archaeologicalSite->subRegion->region_id) == $region->id ? 'selected' : '' }}
                    ...
                    <div class="mb-3">
                        <label for="sub_region_id" class="form-label">
                            Alt Bölge <span class="text-danger">*</span>
                        </label>
                        <select class="form-select @error('sub_region_id') is-invalid @enderror" 
                                id="sub_region_id" name="sub_region_id" required>
                            <option value="">Önce Ana Bölge Seçin</option>
                        </select>
                        @error('sub_region_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if($archaeologicalSite->image)
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <img src="{{ asset('storage/' . $archaeologicalSite->image) }}" 
                                     alt="Site Image" class="img-fluid rounded" style="max-height: 200px;">
                    ...
                    <!-- Resim -->
                    <div class="mb-3">
                        <label for="image" class="form-label">{{ $archaeologicalSite->image ? 'Yeni Resim' : 'Ören Yeri Resmi' }}</label>
                        <input type="file" class="form-control @error('image') is-invalid @enderror" 
                               id="image" name="image" accept="image/*">
                        <small class="text-muted">Maksimum 2MB. Önerilen boyut: 150x150px</small>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title">Özel Ayarlar</h4>
                </div>
                <div class="card-body">
                    <!-- Yakındaki Yerler -->
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input type="checkbox" class="form-check-input" id="is_nearby_enabled" name="is_nearby_enabled" 
                                   value="1" {{ old('is_nearby_enabled', $archaeologicalSite->is_nearby_enabled) ? 'checked' : '' }}>
                            <label class="form-check-label" for="is_nearby_enabled">Yakındaki Yerler Özelliği</label>
                        </div>
                        <small class="text-muted">Bu ören yeri yakındaki yerler listesinde gösterilsin mi?</small>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" 
                                   value="1" {{ old('is_active', $archaeologicalSite->is_active) ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    <div class="preview-card p-3 border rounded" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);">
                        <div class="d-flex align-items-center mb-2">
                            <span class="region-color-preview me-2" style="background-color: {{ $archaeologicalSite->subRegion->region->color_code }}; width: 16px; height: 16px; border-radius: 50%; display: inline-block;"></span>
                            <h6 class="mb-0 site-name-preview">{{ $archaeologicalSite->name ?: 'Ören Yeri Adı' }}</h6>
                        </div>
                        <p class="text-muted mb-2 site-desc-preview small">{{ $archaeologicalSite->description ?: 'Ören yeri açıklaması burada görünecek...' }}</p>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-0">Ören Yeri Güncelleniyor</h6>
...
<div class="modal fade" id="cropModal" tabindex="-1" aria-labelledby="cropModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cropModalLabel">Resmi Kırp</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Kapat"></button>
            </div>
            <div class="modal-body">
                <div class="img-container">
                    <img id="imageToCrop" src="" alt="Kırpılacak resim">
                </div>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Region data for sub-regions

        const regionSubRegions = @json($regionData);
        ...
        regionSelect.addEventListener('change', function() {
            ...
            const selectedRegion = regionSubRegions.find(r => r.id === regionId);

            

            // Clear sub-region options
            ...
            if (selectedRegion && selectedRegion.subRegions && selectedRegion.subRegions.length > 0) {
                ...
                colorPreview.style.backgroundColor = selectedRegion.color;
                ...
                selectedRegion.subRegions.forEach(subRegion => {
                    ...
                    // Check if this is the current sub-region

                    if ('{{ old("sub_region_id", $archaeologicalSite->sub_region_id) }}' == subRegion.id) {
                ...
                // Show message if no sub-regions
        ...
        function updatePreview() {
            ...
            const isNearbyEnabled = document.getElementById('is_nearby_enabled').checked;
            ...
            document.querySelector('.site-name-preview').textContent = nameInput.value || 'Ören Yeri Adı';

            document.querySelector('.site-desc-preview').textContent = descInput.value || 'Ören yeri açıklaması burada görünecek...';

            

            // Coordinates preview

            let coordsText = 'Koordinat bilgisi';

            if (latitude && longitude) {

                coordsText = `${parseFloat(latitude).toFixed(6)}°, ${parseFloat(longitude).toFixed(6)}°`;

            }

            document.querySelector('.coordinates-preview').textContent = coordsText;
        ...
        document.getElementById('is_nearby_enabled').addEventListener('change', updatePreview);
        ...
        document.getElementById('cropModal').addEventListener('shown.bs.modal', function () {
            cropper = new Cropper(imageToCrop, {
                aspectRatio: 1, // 1:1 aspect ratio for 150x150
                viewMode: 1,
                autoCropArea: 1,
            });
        });
        ...
        document.getElementById('cropModal').addEventListener('hidden.bs.modal', function () {
            ...
            if (!imageInput.getAttribute('data-cropped')) {
                 imageInput.value = ''; 
            }
        });
        ...
        cropBtn.addEventListener('click', function() {
            if (cropper) {
                ...
                canvas.toBlob(function(blob) {
                    ...
                    imageInput.setAttribute('data-cropped', 'true');
                    cropModal.hide();

                    // Find existing image preview if any and update it
                    const existingPreview = document.querySelector('.card-body img');
                    if (existingPreview) {
                         existingPreview.src = canvas.toDataURL();
                    }
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (hasError) {
                ...
                alert('En az bir dilde ören yeri adı girilmelidir!');
    ...
    function translateFromTurkish() {
            ...
            if (!turkishName || !turkishName.value.trim()) {
                alert('Lütfen önce Türkçe ören yeri adı girin.');
                return;
            }
            ...
            fetch('/admin/archaeological-sites/translate', {
                method: 'POST',
                headers: {
