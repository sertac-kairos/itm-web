@extends('layouts.vertical', ['title' => 'Yeni Ören Yeri Ekle - İzmir Time Machine', 'topbarTitle' => 'Yeni Ören Yeri'])
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Yeni Ören Yeri</li>
                </ol>
            </div>
            <h4 class="page-title">Yeni Ören Yeri Ekle</h4>
        </div>
    </div>
</div>

<!-- Form -->
<form action="{{ route('admin.archaeological-sites.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error($locale.'.description') is-invalid @enderror" 
                                                      ...
                                                      rows="4" placeholder="Ören yeri hakkında açıklama yazın...">{{ old($locale.'.description') }}</textarea>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Resim -->
                    <div class="mb-3">
                        <label for="image" class="form-label">Ören Yeri Resmi</label>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input type="checkbox" class="form-check-input" id="is_nearby_enabled" name="is_nearby_enabled" 
                                   value="1" {{ old('is_nearby_enabled', true) ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    <div class="preview-card p-3 border rounded" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);">
                        <div class="d-flex align-items-center mb-2">
                            <span class="region-color-preview me-2" style="background-color: #fa5c7c; width: 16px; height: 16px; border-radius: 50%; display: inline-block;"></span>
                            <h6 class="mb-0 site-name-preview">Ören Yeri Adı</h6>
                        </div>
                        <p class="text-muted mb-2 site-desc-preview small">Ören yeri açıklaması burada görünecek...</p>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-0">Ören Yeri Oluşturuluyor</h6>
                            <p class="text-muted mb-0">En az bir dilde (Türkçe önerilir) içerik girmeniz yeterlidir</p>
                        </div>
                        <div>
                            <a href="{{ route('admin.archaeological-sites.index', request()->only(['region_id', 'sub_region_id'])) }}" class="btn btn-secondary me-2">
                                <i class="mdi mdi-arrow-left me-1"></i>İptal
                            </a>
                            <button type="submit" class="btn btn-success">
                                <i class="mdi mdi-content-save me-1"></i>Ören Yerini Kaydet
                            </button>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        regionSelect.addEventListener('change', function() {
            ...
            if (selectedRegion && selectedRegion.subRegions && selectedRegion.subRegions.length > 0) {
                ...
                selectedRegion.subRegions.forEach(subRegion => {
                    ...
                    if ('{{ old("sub_region_id", $selectedSubRegionId) }}' == subRegion.id) {
                ...
                colorPreview.style.backgroundColor = '#fa5c7c';
        ...
        // Trigger change event on page load if region is selected
        ...
        document.getElementById('cropModal').addEventListener('hidden.bs.modal', function () {
            ...
            // If cancelled and no file selected in input (or replaced), we might want to clear input
            // But here we just keep it or let the user select again.
            // To strictly enforce crop, we could clear input if not cropped.
        ...
        cropBtn.addEventListener('click', function() {
            if (cropper) {
                ...
                canvas.toBlob(function(blob) {
                    ...
                    // Mark as cropped so we don't clear it on modal close
                    ...
                    // Optional: Show preview
                     const reader = new FileReader();
                     reader.onload = function(e) {
                         // You can add image preview logic here if there's a preview element
