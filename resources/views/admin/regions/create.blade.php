@extends('layouts.vertical', ['title' => 'Yeni Bölge Ekle - İzmir Time Machine', 'topbarTitle' => 'Yeni Bölge'])
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Yeni Bölge</li>
                </ol>
            </div>
            <h4 class="page-title">Yeni Bölge Ekle</h4>
        </div>
    </div>
</div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error($locale.'.description') is-invalid @enderror" 
                                                      ...
                                                      rows="4" placeholder="Bölge hakkında açıklama yazın...">{{ old($locale.'.description') }}</textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" class="form-control form-control-color @error('color_code') is-invalid @enderror" 
                                   id="color_code" name="color_code" value="{{ old('color_code', '#3498db') }}" required>
                            <input type="text" class="form-control @error('color_code') is-invalid @enderror" 
                                   id="color_code_text" value="{{ old('color_code', '#3498db') }}" pattern="^#[0-9a-fA-F]{6}$">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('hotspot_image') is-invalid @enderror" 
                                  ...
                                  placeholder='{"hotspots": [{"x": 100, "y": 200, "title": "Hotspot 1", "description": "Açıklama"}]}'>{{ old('hotspot_image') }}</textarea>
                        <div class="form-text">
                ...
                <div class="card-body">
                    <div class="preview-card p-3 border rounded" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);">
                        <div class="d-flex align-items-center mb-2">
                            <span class="region-color-preview me-2" style="background-color: #3498db; width: 20px; height: 20px; border-radius: 50%; display: inline-block;"></span>
                            <h6 class="mb-0 region-name-preview">Bölge Adı</h6>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-0">Bölge Oluşturuluyor</h6>
                        ...
                        <div>
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="mdi mdi-content-save me-1"></i>Bölgeyi Kaydet
                            </button>
                        </div>
                    </div>
                </div>
