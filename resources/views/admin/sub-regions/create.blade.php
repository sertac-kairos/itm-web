@extends('layouts.vertical', ['title' => 'Yeni Alt Bölge Ekle - İzmir Time Machine', 'topbarTitle' => 'Yeni Alt Bölge'])
        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Yeni Alt Bölge</li>
                </ol>
            </div>
            <h4 class="page-title">Yeni Alt Bölge Ekle</h4>
        </div>
    </div>
</div>

<!-- Form -->
<form action="{{ route('admin.sub-regions.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error($locale.'.description') is-invalid @enderror" 
                                                      ...
                                                      rows="4" placeholder="Alt bölge hakkında açıklama yazın...">{{ old($locale.'.description') }}</textarea>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Resim -->
                    <div class="mb-3">
                        <label for="image" class="form-label">Alt Bölge Resmi</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror" 
                               id="color" name="color" value="{{ old('color', '#1a4a9f') }}">
                ...
                <div class="card-body">
                    <div class="preview-card p-3 border rounded" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%);">
                        <div class="d-flex align-items-center mb-2">
                            <span class="region-color-preview me-2" style="background-color: #3498db; width: 16px; height: 16px; border-radius: 50%; display: inline-block;"></span>
                            <h6 class="mb-0 subregion-name-preview">Alt Bölge Adı</h6>
                        </div>
                        <p class="text-muted mb-2 subregion-desc-preview small">Alt bölge açıklaması burada görünecek...</p>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="mb-0">Alt Bölge Oluşturuluyor</h6>
                            <p class="text-muted mb-0">En az bir dilde (Türkçe önerilir) içerik girmeniz yeterlidir</p>
                        </div>
                        <div>
                            <a href="{{ route('admin.sub-regions.index', request()->only('region_id')) }}" class="btn btn-secondary me-2">
                                <i class="mdi mdi-arrow-left me-1"></i>İptal
                            </a>
                            <button type="submit" class="btn btn-success">
                                <i class="mdi mdi-content-save me-1"></i>Alt Bölgeyi Kaydet
                            </button>
                        </div>
                    </div>
                </div>
