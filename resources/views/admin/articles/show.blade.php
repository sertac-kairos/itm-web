@extends('layouts.vertical', ['title' => 'Yazı Detayı - İzmir Time Machine', 'topbarTitle' => 'Yazı Detayı'])
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Yazı Detayı: {{ $article->translate(app()->getLocale())->title ?? 'Başlıksız' }}</h4>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <table class="table table-borderless table-sm mb-0">
                        <tr>
                            ...
                            <td><span class="badge badge-soft-secondary">#{{ $article->id }}</span></td>
                        </tr>
                        <tr>
                            <td class="fw-medium">Yazar:</td>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-soft-info">{{ $article->images_count }}</span></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('admin.articles.edit', $article) }}" class="btn btn-info">
                ...
                <div class="card">
                    <div class="card-body text-center py-4">
                        <div class="text-muted">
                            ...
                            <p>Bu yazıya resim eklemek için düzenleme sayfasını kullanın.</p>
                        </div>
                    </div>
                </div>
            @endif
