                            ...
                            <select class="form-select" id="region_id">
                                ...
                                @foreach($regions as $region)
                                    <option value="{{ $region->id }}" 
                                            {{ old('region_id', $model3d->archaeologicalSite?->subRegion?->region_id ?? '') == $region->id ? 'selected' : '' }}
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="archaeological_site_id">
                                ...
                                <span id="edit-site-link" style="display: none;">
                                    <a href="#" id="edit-site-btn" class="btn btn-sm btn-outline-primary ms-2" title="Ören Yerini Düzenle">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const currentSiteId = {{ old('archaeological_site_id', $model3d->archaeological_site_id ?? 0) }};
        const currentSubRegionId = {{ old('sub_region_id', $model3d->archaeologicalSite?->sub_region_id ?? 0) }};
        const currentRegionId = {{ old('region_id', $model3d->archaeologicalSite?->subRegion?->region_id ?? 0) }};
