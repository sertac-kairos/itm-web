@extends('layouts.vertical', ['title' => 'Yeni İçerik Ekle - İzmir Time Machine', 'topbarTitle' => 'Yeni İçerik'])
...
@section('content')
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Yeni İçerik</li>
                    </ol>
                </div>
                <h4 class="page-title">Yeni İçerik Ekle</h4>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('admin.memories.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="header-title">Resim Önizleme</h4>
                    </div>
