@extends('layouts.vertical', ['title' => 'Yeni Haber/Etkinlik Ekle - İzmir Time Machine', 'topbarTitle' => 'Yeni Haber/Etkinlik'])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Yeni Haber/Etkinlik</li>
                    </ol>
                </div>
                <h4 class="page-title">Yeni Haber/Etkinlik Ekle</h4>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div id="content_editor_{{ $locale }}" style="height: 300px; border: 1px solid #ddd; background: #f9f9f9;" class="@error("{$locale}.content") is-invalid @enderror">
                                                    <div style="padding: 20px; text-align: center; color: #666;">
                                                        <i class="mdi mdi-loading mdi-spin" style="font-size: 24px;"></i>
                                                        <p>Rich Text Editör Yükleniyor...</p>
                                                    </div>
                                                </div>
                                                <textarea class="form-control d-none" 
                                                          id="content_{{ $locale }}" name="{{ $locale }}[content]" 
                                                          {{ $locale === config('translatable.fallback_locale') ? 'required' : '' }}>{{ old("{$locale}.content") }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('news_date') is-invalid @enderror" 
                                   id="news_date" name="news_date" value="{{ old('news_date') }}" 
                                   required>
                            @error('news_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
