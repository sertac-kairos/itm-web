@extends('layouts.vertical', ['title' => 'Ratings', 'topbarTitle' => 'Ratings'])
...
<div class="row row-cols-lg-2">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">You can have unlimited number of stars. Example with 16 stars.
                    readOnly option is set to true.</p>
                <div>
